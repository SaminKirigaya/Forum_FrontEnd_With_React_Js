            ...
            try {
                ...
                if(response2.status === 200){
                    if(response2.data.message == 'Successful'){
                        this.setState({ 
                            startingintro : response2.data.editPost.intro,
                            startingtype :  response2.data.editPost.problem_type,
                            startingpost : response2.data.editPost.user_post


                        });
                        console.log(this.state.postfield)
